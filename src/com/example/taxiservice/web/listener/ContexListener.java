...
public class ContexListener implements ServletContextListener {
	...
	private void initI18N(ServletContext servletContext) {
		...
		String localesValue = servletContext.getInitParameter(Parameter.LOCALES);
		...
		if (localesValue == null || localesValue.isEmpty()) {
			...
			servletContext.setAttribute(Attribute.LOCALES, locales);
		}
		...
		if (defaultLocale == null || defaultLocale.isEmpty()) {
			...
			servletContext.setAttribute(Attribute.LOCALE__DEFAULT, defaultLocale);
		}
	...
	private void initCommandContainer(ServletContext servletContext) {
		...
		String commandsValue = servletContext.getInitParameter(Parameter.COMMANDS);
