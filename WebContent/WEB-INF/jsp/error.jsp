	...
	<div class="container ">
		<div class="row">
			<div class="col-sm-offset-3 col-md-6 inf-content">
				<h3>
					<fmt:message key="error_jsp.anchor.info" />
				</h3>
				<hr>
				<div class="error-template">
					<img alt="" style="width: 300px;" class="img-rounded"
						src="image/error.png">
					<h1>
					...
					<br> <a href="?command=home_page" class="btn btn-default"
						role="button"><fmt:message key="general.button.anchor.home" /></a>
				</div>
			</div>
		</div>
	</div>
