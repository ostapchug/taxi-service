...
<body>
	...
	<div class="page-header">
		<div class="container">
			<h2>
				<fmt:message key="general.anchor.trips" />
			</h2>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="inf-content">
				<h3>
					<fmt:message key="trips_jsp.anchor.info" />
				</h3>
				<hr>

				<c:choose>
					<c:when
						test="${not empty tripList or not empty dateRange or not empty phone}">
					...
					<c:otherwise>
						<div class="empty-template">
							<h3 class="text-muted">
								<fmt:message key="trips_jsp.anchor.table.empty" />
							</h3>
